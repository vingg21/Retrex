...
QT_MOC_LITERAL(7, 108, 28), // "anonymizeRetrexAmountChanged"
QT_MOC_LITERAL(8, 137, 26), // "coinControlFeaturesChanged"
QT_MOC_LITERAL(9, 164, 23) // "hideZeroBalancesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "zeromintEnableChanged\0zeromintPercentageChanged\0"
    "preferredDenomChanged\0"
    "anonymizeRetrexAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->anonymizeRetrexAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeRetrexAmountChanged)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void OptionsModel::anonymizeRetrexAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
