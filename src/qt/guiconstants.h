...
/* Retrex GUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 38;
...
#define QAPP_ORG_NAME "Retrex"
#define QAPP_ORG_DOMAIN "retrex.tech"
#define QAPP_APP_NAME_DEFAULT "Retrex-Qt"
#define QAPP_APP_NAME_TESTNET "Retrex-Qt-testnet"
