...
public:
    ...
    QCheckBox *checkzREEX;
    QCheckBox *checkSwiftTX;
    QLabel *labelForBalance;
    QLabel *labelBalance;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 REEX"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 REEX"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 944, 110));
        ...
        verticalLayoutFee3->setContentsMargins(-1, 2, -1, 0);
        ...
        labelSmartFeeNormal->setFont(font1);
        ...
        labelSmartFeeFast->setFont(font1);
        ...
        checkzREEX = new QCheckBox(frame_Send);
        checkzREEX->setObjectName(QStringLiteral("checkzREEX"));
        checkzREEX->setEnabled(false);

        horizontalLayout_2->addWidget(checkzREEX);
        ...
        labelForBalance = new QLabel(frame_Send);
        labelForBalance->setObjectName(QStringLiteral("labelForBalance"));

        horizontalLayout_2->addWidget(labelForBalance);
        ...
        labelBalance->setText(QStringLiteral("123.456 REEX"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 REEX", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uREEXs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uREEXs in fee,<br />while \"at least\" pays 1000 uREEXs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uREEXs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uREEXs in fee,<br />while \"total at least\" pays 1000 uREEXs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Retrex transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Retrex transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkzREEX->setText(QApplication::translate("SendCoinsDialog", "Anonymized Retrex", Q_NULLPTR));
        checkSwiftTX->setText(QApplication::translate("SendCoinsDialog", "SwiftX", Q_NULLPTR));
        labelForBalance->setText(QApplication::translate("SendCoinsDialog", "Balance:", Q_NULLPTR));
    } // retranslateUi
