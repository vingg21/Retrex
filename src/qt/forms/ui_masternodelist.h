...
public:
    ...
    QPushButton *configureMasternodeButton;
    ...
    void setupUi(QWidget *MasternodeList)
    {
        ...
        tableWidgetMyMasternodes->setLineWidth(0);
        ...
        configureMasternodeButton = new QPushButton(frameList);
        configureMasternodeButton->setObjectName(QStringLiteral("configureMasternodeButton"));

        horizontalLayout_5->addWidget(configureMasternodeButton);
    ...
    void retranslateUi(QWidget *MasternodeList)
    {
        ...
        configureMasternodeButton->setText(QApplication::translate("MasternodeList", "A&dd Masternode", Q_NULLPTR));
        ...
        autoupdate_label->setText(QApplication::translate("MasternodeList", "Update in (sec):", Q_NULLPTR));
