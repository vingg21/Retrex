...
public:
    ...
    QLabel *wallet_customzreexbackuppath_label;
    QLabel *wallet_customzreexbackuppath;
    ...
    QPushButton *btn_convert_to_hd_Wallet;
    QLabel *label_convert_to_hd_Wallet_command;
    QLabel *label_convert_to_hd_Wallet;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzreexbackuppath_label = new QLabel(tab_repair);
        wallet_customzreexbackuppath_label->setObjectName(QStringLiteral("wallet_customzreexbackuppath_label"));
        wallet_customzreexbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzreexbackuppath_label, 4, 0, 1, 1);

        wallet_customzreexbackuppath = new QLabel(tab_repair);
        wallet_customzreexbackuppath->setObjectName(QStringLiteral("wallet_customzreexbackuppath"));
        wallet_customzreexbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzreexbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzreexbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        wallet_customzreexbackuppath->setVisible(false);

        gridLayout_4->addWidget(wallet_customzreexbackuppath, 4, 1, 1, 3);
        ...
        btn_convert_to_hd_Wallet = new QPushButton(tab_repair);
        btn_convert_to_hd_Wallet->setObjectName(QStringLiteral("btn_convert_to_hd_Wallet"));
        btn_convert_to_hd_Wallet->setMinimumSize(QSize(100, 23));

        gridLayout_4->addWidget(btn_convert_to_hd_Wallet, 14, 0, 1, 2);

        label_convert_to_hd_Wallet_command = new QLabel(tab_repair);
        label_convert_to_hd_Wallet_command->setObjectName(QStringLiteral("label_convert_to_hd_Wallet_command"));

        gridLayout_4->addWidget(label_convert_to_hd_Wallet_command, 14, 2, 1, 1);

        label_convert_to_hd_Wallet = new QLabel(tab_repair);
        label_convert_to_hd_Wallet->setObjectName(QStringLiteral("label_convert_to_hd_Wallet"));
        label_convert_to_hd_Wallet->setWordWrap(true);

        gridLayout_4->addWidget(label_convert_to_hd_Wallet, 14, 3, 1, 1);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Retrex debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzreexbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zREEX Backup Path:", Q_NULLPTR));
        wallet_customzreexbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
        ...
        btn_convert_to_hd_Wallet->setText(QApplication::translate("RPCConsole", "Upgrade non-hd wallet to hd", Q_NULLPTR));
        label_convert_to_hd_Wallet_command->setText(QApplication::translate("RPCConsole", "-rescan:", Q_NULLPTR));
        label_convert_to_hd_Wallet->setText(QApplication::translate("RPCConsole", "Upgrade non-hd wallet to hd", Q_NULLPTR));
