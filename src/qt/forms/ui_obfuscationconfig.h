...
public:
    ...
    void retranslateUi(QDialog *ObfuscationConfig)
    {
        ...
        label_2->setText(QApplication::translate("ObfuscationConfig", "Use 2 separate masternodes to mix funds up to 10000 REEX", Q_NULLPTR));
        label_3->setText(QApplication::translate("ObfuscationConfig", "Use 8 separate masternodes to mix funds up to 10000 REEX", Q_NULLPTR));
        label_4->setText(QApplication::translate("ObfuscationConfig", "Use 16 separate masternodes", Q_NULLPTR));
        label_6->setText(QApplication::translate("ObfuscationConfig", "This option is the quickest and will cost about ~0.025 REEX to anonymize 10000 REEX", Q_NULLPTR));
        label_7->setText(QApplication::translate("ObfuscationConfig", "This option is moderately fast and will cost about 0.05 REEX to anonymize 10000 REEX", Q_NULLPTR));
        ...
        label_9->setText(QApplication::translate("ObfuscationConfig", "0.1 REEX per 10000 REEX you anonymize.", Q_NULLPTR));
    } // retranslateUi
