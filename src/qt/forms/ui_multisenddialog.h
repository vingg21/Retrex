...
public:
    ...
    void setupUi(QDialog *MultiSendDialog)
    {
        ...
        multiSendHeader = new QLabel(MultiSendDialog);
        multiSendHeader->setObjectName(QStringLiteral("multiSendHeader"));
        QFont font;
        font.setFamily(QStringLiteral("Hind"));
        font.setPointSize(30);
        font.setBold(false);
        font.setWeight(50);
        multiSendHeader->setFont(font);
        multiSendHeader->setAlignment(Qt::AlignCenter);

        verticalLayout_Main->addWidget(multiSendHeader);
        ...
        verticalLayout_Main->setStretch(7, 1);
    ...
    void retranslateUi(QDialog *MultiSendDialog)
    {
        ...
        multiSendHeader->setText(QApplication::translate("MultiSendDialog", "MultiSend", Q_NULLPTR));
        label_2->setText(QApplication::translate("MultiSendDialog", "MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other Retrex addresses after it matures.\n"
