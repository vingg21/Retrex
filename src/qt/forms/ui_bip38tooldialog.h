...
public:
    ...
    void setupUi(QDialog *Bip38ToolDialog)
    {
        ...
        addressBookButton_ENC->setAutoFillBackground(false);
        QIcon icon;
    ...
    void retranslateUi(QDialog *Bip38ToolDialog)
    {
        ...
        infoLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Enter a Retrex Address that you would like to encrypt using BIP 38. Enter a passphrase in the middle box. Press encrypt to compute the encrypted private key.", Q_NULLPTR));
        label_5->setText(QApplication::translate("Bip38ToolDialog", "Address:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        addressIn_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "The Retrex address to sign the message with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Encrypt the private key for this Retrex address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
