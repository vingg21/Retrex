...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        addressBookButton->setIconSize(QSize(16, 16));
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Retrex address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        payTo->setInputMask(QString());
        payTo->setPlaceholderText(QApplication::translate("SendCoinsEntry", "Enter a Retrex address (e.g. PCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        addAsLabel->setInputMask(QString());
        addAsLabel->setPlaceholderText(QApplication::translate("SendCoinsEntry", "Enter a label for this address to add it to your address book", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the Retrex: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Retrex network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
