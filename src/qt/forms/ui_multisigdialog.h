...
public:
    ...
    void setupUi(QDialog *MultisigDialog)
    {
        ...
        multisigTabWidget->setLayoutDirection(Qt::LeftToRight);
        multisigTabWidget->setStyleSheet(QStringLiteral(""));
        ...
        addAddressScrollArea->setStyleSheet(QStringLiteral("border:0;"));
        ...
        addAddressWidget->setGeometry(QRect(0, 0, 761, 184));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/css/default"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        txInputsScrollArea->setStyleSheet(QStringLiteral("border:0;"));
        txInputsScrollArea->setLineWidth(0);
        ...
        txInputsWidget->setGeometry(QRect(0, 0, 749, 141));
        ...
        destionationsScrollArea->setStyleSheet(QStringLiteral("border:0;"));
        ...
        destinationsScrollAreaContents->setGeometry(QRect(0, 0, 749, 140));
...
#ifndef QT_NO_TOOLTIP
        addDestinationButton->setToolTip(QApplication::translate("MultisigDialog", "Add destinations to send REEX to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
